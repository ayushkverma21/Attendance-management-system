...
<div class="clear"></div>
    ...
    <h1 style="color:#8b0909;text-align:center;font-size:36px">View Record</h1>
    
    
    <div id="swa" style="transition-duration: 1s;margin-top:40px">
   ...
   <div id="man" style="margin-left: 16px">
        <a href="show.php?sem=sem1_data&dir=Diploma"><div class="sem1">
            <hr />
        <h3>Semester 1</h3>
       </div>  </a>      <hr />
        <a href="show.php?sem=sem2_data&dir=Diploma"><div class="sem2">
        <h3>Semester 2</h3>
            </div></a> <hr />
        <a href="show.php?sem=sem3_data&dir=Diploma"><div class="sem3">
        <h3>Semester 3</h3>
            </div> </a><hr />
        <a href="show.php?sem=sem4_data&dir=Diploma"><div class="sem4">
        <h3>Semester 4</h3>
            </div> </a><hr />
       <a href="show.php?sem=sem5_data&dir=Diploma"> <div class="sem5">
        <h3>Semester 5</h3>
           </div> </a><hr />
        <a href="show.php?sem=sem6_data&dir=Diploma"><div class="sem6">
        <h3>Semester 6</h3>
            </div></a> 
        </div>
    ...
    <div  style="width: 95%;height: 80px"><div style="margin-left: 20px;height:100%;overflow:hidden;width:100%" id = "sh"><h2>B.Tech<div id="ass2" style= "width: 50px;height: 20px;background-image:url(images/drop.png);background-repeat: no-repeat;background-size: 30px;background-position: right;transform: rotate(-90deg);float: right;margin-top: 20px;transition-timing-function: ease-in-out;transition-duration: 0.3s"></div></h2></div>
        ...
        <a href="show.php?sem=sem1_data.csv&dir=Btech"><div class="sem1">
             <hr />
        <h3>Semester 1</h3>
            </div></a> <hr />
      <a href="show.php?sem=sem2_data&dir=Btech">  <div class="sem2">
        <h3>Semester 2</h3>
          </div></a> <hr />
        <a href="show.php?sem=sem3_data&dir=Btech"><div class="sem3">
        <h3>Semester 3</h3>
            </div> </a><hr />
        <a href="show.php?sem=sem4_data&dir=Btech"><div class="sem4">
        <h3>Semester 4</h3>
            </div> </a><hr />
       <a href="show.php?sem=sem5_data&dir=Btech"> <div class="sem5">
        <h3>Semester 5</h3>
           </div></a> <hr />
        <a href="show.php?sem=sem6_data&dir=Btech"><div class="sem6">
        <h3>Semester 6</h3>
            </div></a> <hr />
        <a href="show.php?sem=sem7_data&dir=Btech"><div class="sem7">
        <h3>Semester 7</h3>
            </div></a> <hr />
        <a href="show.php?sem=sem8_data&dir=Btech"><div class="sem8">
        <h3>Semester 8</h3>
    ...
    <div style="width: 95%;height: 80px"><div style="margin-left: 20px;height:100%;overflow:hidden;width:100%" id = "ku"><h2>M.Tech<div id="ass3" style= "width: 50px;height: 20px;background-image:url(images/drop.png);background-repeat: no-repeat;background-size: 30px;background-position: right;transform: rotate(-90deg);float: right;margin-top: 20px;transition-timing-function: ease-in-out;transition-duration: 0.3s"></div></h2></div>
        ...
        <a href="show.php?sem=sem1_data&dir=Mtech"> <div class="sem1">
             <hr />
        <h3>Semester 1</h3>
           </div></a> <hr />
       <a href="show.php?sem=sem2_data&dir=Mtech"> <div class="sem2">
        <h3>Semester 2</h3>
           </div> </a><hr />
        <a href="show.php?sem=sem3_data&dir=Mtech"><div class="sem3">
        <h3>Semester 3</h3>
            </div></a> <hr />
        <a href="show.php?sem=sem4_data&dir=Mtech"><div class="sem4">
